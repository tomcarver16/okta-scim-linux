...
* Testing your SCIM server with Runscope			   :noexport:
** Set up Runscope
   ...
   [[https://www.runscope.com/pricing-and-plans][Runscope's free plan]]. Here is how to get started:
...
** Customize the imported Runscope test for your SCIM integration
   ...
   After importing Okta's SCIM test suite into Runscope, it is time to
   update the tests for your SCIM integration. Here is how to do that:
   ...
   7. Set the value of the "SCIM Base URL" to the base URL for your
      SCIM integration. For example, if your SCIM integration is
      hosted on =https://example.com= and uses a prefix of =/scim/v2= then the
      "SCIM Base URL" for your integration would be: =https://example.com/scim/v2=
...
** Sharing test results with Okta
